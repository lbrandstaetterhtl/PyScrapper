...
public partial class MediaPlayerWindow : Window
{
    ...
    public MediaPlayerWindow(List<DownloadedMedia> medias)
    {
        ...
        VideoView.Initialized += (s, e) =>
        {
            if (DataContext is MediaPlayerWindowViewModel vm)
            {
                VideoView.MediaPlayer = vm.AudioPlayer.Player;
            }
        };
        ...
        {
            if (media.DownloadPath.EndsWith(".mp4") || media.DownloadPath.EndsWith(".mkv") || media.DownloadPath.EndsWith(".avi"))
            {
                enableVideo = true;
                break;
            }
        ...
        var audioPlayer = new AudioPlayer(enableVideo);
        
        _vm = new MediaPlayerWindowViewModel(audioPlayer, medias);
